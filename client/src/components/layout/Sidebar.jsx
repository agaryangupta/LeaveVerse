...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
    ...
    return (
        <>
            ...
            <div
                className={`fixed lg:relative top-0 left-0 h-screen lg:min-h-screen w-64 shrink-0 flex flex-col justify-between z-50 lg:z-auto transform transition-transform duration-300
        ${sidebarOpen
                        ? "translate-x-0"
